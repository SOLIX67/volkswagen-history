...
function initContactForm() {
    ...
    contactForm.addEventListener('submit', async (e) => {
        ...
        try {
            // If running locally, try local API; otherwise fall back to email
            ...
            if (isLocal) {
                ...
                // Build a mailto link as a safe fallback for production
                const to = 'omphile67@icloud.com';
                ...
                showFormStatus('success', 'Opening your email app to send the message.');
                contactForm.reset();
            }
        } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tabBtns.forEach(btn => {
        btn.addEventListener ('click', function() {
            ...
            // Support both data-target (CSS selector) and data-tab (ID)
